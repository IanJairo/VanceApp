...
import { StyleSheet, View, Text, Image, Dimensions, TouchableOpacity, Picker} from 'react-native';
    ...
    <View style={styles.container}>
      ...
      <View style={styles.themeView}>
        ...
        <BouncyCheckbox
            ...
            onPress={() => setSystemPreferences(!systemPreferences)}
          />
      </View>
      ...
      <View style={styles.configsView}>
        ...
        <View style={styles.section}>
          ...
          <RNPickerSelect
            onValueChange={(itemValue) => handleFontChange(itemValue)}
            items={[
